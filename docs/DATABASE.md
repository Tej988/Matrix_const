...
unbilled; a bill draft exists before it is linked. This is what keeps _billed_ and _measured_
...
is ever called _profit_: §17 forbids that unless all costs are captured, and they are not.
...
against its _live_ value at approval time, never against the value a draft was typed
against.
...
## What is deliberately _not_ modelled in v1

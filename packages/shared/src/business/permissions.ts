...
export const PERMISSIONS = [
  ...
  'boq:read', 'boq:write',
  'measurement:read', 'measurement:create', 'measurement:approve',
  'bill:read', 'bill:create', 'bill:cancel',
  'clientPayment:read', 'clientPayment:create', 'clientPayment:confirm',
  'labour:read', 'labour:write',
  'attendance:read', 'attendance:write',
  'wage:read', 'wage:lock',
  'labourPayment:read', 'labourPayment:write',
